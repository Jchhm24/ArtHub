export const CuentaDropwnComponent = () => {
    ...
    return (
      <div>   
          <input type="checkbox" id="acount" className="peer hidden"/>
          {/* Icono del perfil */}
          <label htmlFor="acount" className="cursor-pointer pr-5 flex flex-row items-center gap-[5px] rounded-full hover:bg-vulcan-900 peer-checked:hidden">
              ...
              <svg className="fill-yellow-orange-300 w-[30px] h-[30px]" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M480-362q-8 0-15-2.5t-13-8.5L268-557q-11-11-11-28t11-28q11-11 28-11t28 11l156 156 156-156q11-11 28-11t28 11q11 11 11 28t-11 28L508-373q-6 6-13 8.5t-15 2.5Z"/></svg>
          </label>

          <label htmlFor="acount" className="hidden cursor-pointer pr-5 flex-row items-center gap-[5px] rounded-full bg-yellow-orange-300 peer-checked:flex">
              <div className="bg-white rounded-full">
                  <svg className="fill-vulcan-900 w-10 h-10" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M234-276q51-39 114-61.5T480-360q69 0 132 22.5T726-276q35-41 54.5-93T800-480q0-133-93.5-226.5T480-800q-133 0-226.5 93.5T160-480q0 59 19.5 111t54.5 93Zm246-164q-59 0-99.5-40.5T340-580q0-59 40.5-99.5T480-720q59 0 99.5 40.5T620-580q0 59-40.5 99.5T480-440Zm0 360q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q53 0 100-15.5t86-44.5q-39-29-86-44.5T480-280q-53 0-100 15.5T294-220q39 29 86 44.5T480-160Zm0-360q26 0 43-17t17-43q0-26-17-43t-43-17q-26 0-43 17t-17 43q0 26 17 43t43 17Zm0-60Zm0 360Z"/></svg>
              </div>
          ...
          <div className="hidden absolute flex-col items-center gap-0 -translate-x-6 peer-checked:flex">
              ...
              <div className="bg-vulcan-900 rounded-lg">
                  ...
                  <button onClick={exit} className="flex flex-row p-[6px] gap-1 cursor-pointer hover:text-gold-sand-300">
