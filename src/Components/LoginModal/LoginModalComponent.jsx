...
export const LoginModalComponent = ({opendModal, closeModal}) => {
  ...
  return (
    <>  
        ...
        <dialog open={opendModal} className='bg-pickled-bluewood-950 rounded-[20px] w-[1110px] h-[550px] backdrop-blur-[50px] outline-none
        flex flex-row items-center place-content-evenly z-30 absolute inset-0'>
            {/* Formulario del registro */}
            <section className="w-[555px] flex justify-center">
                <div className="bg-pickled-bluewood-800 rounded-[20px] p-5 w-max h-[497px] flex flex-col items-center justify-center gap-5">
                    ...
                    <div className="flex flex-row gap-16 font-Comfortaa font-medium text-yellow-orange-300">
                        <button className="text-java-400 flex flex-row bg-blue-bayoux-900 rounded-[10px] px-[6px] py-1 outline-none" onClick={closeModal}>
                    ...
                    <form className="flex flex-col gap-5" onSubmit={onSubmitUser}>
                        ...
                        <div className="flex justify-center">
                            <button type="submit" className="font-Comfortaa text-blue-bayoux-950 bg-yellow-orange-300 px-[6px] py-1 rounded-[10px] border-2 border-yellow-orange-300
                                hover:text-blue-bayoux-900 hover:border-red-damask-400 transition-all duration-500">
                                ¡Registrarse!
                            </button>
                        </div>
                    </form>
            ...
            <section className="w-[555px] flex justify-center">
                <div className="bg-pickled-bluewood-800 rounded-[20px] p-5 h-[497px] flex flex-col items-center justify-center gap-5">
                    <h1 className="font-Red-Hat-Display font-semibold text-[32px] text-yellow-orange-300 pb-[10px] border-b-4 border-yellow-orange-300 w-full text-center">
                        Iniciar sesión
                    </h1>
                    {/* Opciones del modal */}
                    <div className="flex flex-row gap-14 font-Comfortaa font-medium text-yellow-orange-300">
                        <button
                        className="text-java-400 flex flex-row bg-blue-bayoux-900 rounded-[10px] px-[6px] py-1 outline-none"
                    ...
                    <form className="flex flex-col gap-5 w-full" onSubmit={onGetUser}>
                        ...
                        <div className="flex flex-col items-center justify-center gap-5 font-Red-Hat-Display text-yellow-orange-300">
                            <div className="flex gap-1">
                                <a href="#" className="hover:text-red-damask-400 hover:underline">
                        ...
                        <div className="flex justify-center">
                            <button type="submit" className="font-Comfortaa text-blue-bayoux-950 bg-yellow-orange-300 px-[6px] py-1 rounded-[10px] border-4 border-yellow-orange-300
                                hover:text-blue-bayoux-900 hover:border-red-damask-400 transition-all duration-500">
                                ¡Registrarse!
                            </button>
                        </div>
